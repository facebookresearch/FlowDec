...
def ddpm_conv1x3(in_planes, out_planes, stride=1, bias=True, dilation=1, init_scale=1., padding=1):
  """1x3 convolution with DDPM initialization."""
  conv = nn.Conv2d(in_planes, out_planes, kernel_size=(1, 3), stride=stride, padding=(0, padding),
                   dilation=dilation, bias=bias)
  conv.weight.data = default_init(init_scale)(conv.weight.data.shape)
  nn.init.zeros_(conv.bias)
  return conv

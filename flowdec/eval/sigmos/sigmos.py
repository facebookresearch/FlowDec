...
class SigMOS:
    ...
    '''
    def __init__(self, model_dir, model_version=Version.V1, cuda_device=None):
        ...
        if cuda_device is not None:
            providers = [('CUDAExecutionProvider', {'device_id': cuda_device}), 'CPUExecutionProvider']
        else:
            providers = ['CPUExecutionProvider']
        self.session = ort.InferenceSession(
            model_path_history[model_version], sess_options=options,
            providers=providers
        )
